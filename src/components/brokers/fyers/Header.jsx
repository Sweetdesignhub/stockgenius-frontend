...
function Header() {
  ...
  return (
    <div className="h-[10%] grid grid-cols-[1fr,auto,1fr] sm:flex sm:justify-between items-center  border-b w-full max-w-full overflow-x-hidden">
      <h1 className="font-[poppins] font-semibold whitespace-nowrap">
        Account Manager
      </h1>
