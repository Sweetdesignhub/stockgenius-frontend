...
function AccountInfo() {
  ...
  return (    <div className='flex flex-col lg:flex-row items-start lg:items-center justify-between py-3 lg:py-4 space-y-6 lg:space-y-0 w-full max-w-full overflow-x-hidden'>
