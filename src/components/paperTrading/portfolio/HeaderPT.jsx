    ...
    <div className="flex justify-between items-center pb-2 border-b">
      ...
      <div className="flex gap-3">
        ...
        <div className="relative group">
          ...
          <span className="absolute bottom-11 left-[-25px] right-0 text-center text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
            Paper Trading
          </span>
        </div>
      </div>
