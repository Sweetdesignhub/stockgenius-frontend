...
export default function PlanDetailsDialog({ isOpen = false, onClose, initialPlan = 'pro' }) {
  ...
  // Handle plan switching between PRO and MASTER
  const handlePlanClick = (plan) => {
    setSelectedPlan(plan);
  };

  // Handle the transition between dialogs
  const handleSelectPlan = () => {
    console.log(`Selected ${selectedPlan.toUpperCase()} Plan`);
    setShowPlanSelect(true); // First set the state to show next dialog
    onClose(); // Then close this dialog
  };
  ...
  return (
    <>
      ...
      {/* Render PlanSelectDialog separately from the Transition */}
      <PlanSelectDialog
