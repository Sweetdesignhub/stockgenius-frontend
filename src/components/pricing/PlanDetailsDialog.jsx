  ...
  <div className='flex items-center space-x-2 sm:space-x-3'>
    <svg
      className={`w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 ${
        plan === 'pro' ? 'text-[rgba(69,252,252,1)]' : 'text-[rgba(73,255,91,1)]'
      }`}
      fill='none'
      stroke='currentColor'
      viewBox='0 0 24 24'
...
export default function PlanSelectDialog({ isOpen = false, onClose, initialPlan = 'pro' }) {
  ...
  useEffect(() => {
    ...
    if (!sessionId || hasProcessed.current || sessionIdRef.current === sessionId) return;
    ...
    const handleSuccess = async () => {
      ...
      try {
        ...
        await api.get(`/api/v1/stripe/success?session_id=${sessionId}`, {
          withCredentials: true,
        });
                    ...
                    <div className='flex justify-center space-x-2 sm:space-x-3 px-2 sm:px-0'>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          borderImageSource:
                            'linear-gradient(180deg, rgba(39, 136, 72, 0.4) 17.19%, rgba(98, 251, 141, 0.77) 100%), linear-gradient(0deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 255, 0.2)), linear-gradient(180deg, rgba(39, 136, 60, 0) -4.69%, rgba(189, 254, 196, 0.3) 100%)',
                          borderImageSlice: '1',
                          backdropFilter: 'blur(17.94871711730957px)',
                          WebkitBackdropFilter: 'blur(17.94871711730957px)',
                          boxShadow:
