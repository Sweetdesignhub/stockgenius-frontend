...
export default function PlanSelectDialog({
  ...
  //       { 
  //         plan, 
  //         billingCycle,          success_url: `${window.location.origin}/payment/success`,
  ...
  //     const errorMessage = error.message || error.response?.data?.error || "An unexpected error occurred during checkout";
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      {/* <h4 className="font-['Poppins'] text-[18px] font-semibold text-white mb-2">Yearly</h4> */}
                ...
                <div
                  ...
                  style={{
                    ...
                    borderImageSource:
                      "linear-gradient(180deg, rgba(136, 39, 118, 0.4) 17.19%, rgba(251, 98, 228, 0.77) 100%), linear-gradient(0deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)), linear-gradient(180deg, rgba(136, 39, 118, 0) -4.69%, rgba(254, 189, 245, 0.3) 100%)",
                    borderImageSlice: 1,
                    backdropFilter: "blur(17.94871711730957px)",
                    boxShadow:
                    ...
                    <button
                      ...
                      style={{
                        background:
                          "linear-gradient(180deg, rgba(0, 0, 0, 0) -40.91%, #882776 132.95%)",
                        borderImageSource:
                          "linear-gradient(180deg, rgba(136, 39, 118, 0.4) 17.19%, rgba(251, 98, 241, 0.77) 100%), linear-gradient(0deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)), linear-gradient(180deg, rgba(136, 39, 118, 0) -4.69%, rgba(254, 189, 253, 0.3) 100%)",
                        borderImageSlice: "1",
                        gap: "10.77px",
                        backdropFilter: "blur(17.94871711730957px)",
                        boxShadow:
                ...
                <div
                  ...
                  style={{
                    ...
                    borderImageSource:
                      "linear-gradient(180deg, rgba(39, 67, 136, 0.4) 17.19%, rgba(98, 140, 251, 0.77) 100%), linear-gradient(0deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)), linear-gradient(180deg, rgba(39, 59, 136, 0) -4.69%, rgba(189, 200, 254, 0.3) 100%)",
                    borderImageSlice: 1,
                    backdropFilter: "blur(17.94871711730957px)",
                    boxShadow:
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      {/* <h4 className="font-['Poppins'] text-[18px] font-semibold text-white mb-2">Quarterly</h4> */}
                      <div className="flex flex-col items-start">
                        <span
                          className="font-['Poppins'] text-[108px] font-extrabold leading-[100%] tracking-[0.02em]"
                          style={{
                    ...
                    <button
                      ...
                      style={{
                        background:
                          "linear-gradient(180deg, rgba(0, 0, 0, 0) -40.91%, #200B5C 132.95%)",
                        borderImageSource:
                          "linear-gradient(180deg, rgba(11, 43, 92, 0.4) 17.19%, rgba(101, 98, 251, 0.77) 100%), linear-gradient(0deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)), linear-gradient(180deg, rgba(11, 48, 92, 0) -4.69%, rgba(189, 211, 254, 0.3) 100%)",
                        borderImageSlice: "1",
                        gap: "10.77px",
                        backdropFilter: "blur(17.94871711730957px)",
                        boxShadow:
