...
function ModuleContent() {
  ...
  return (
    <div className="w-[90%] flex flex-col gap-8">
      {/* Top Section (20%) - Darker Golden Glass */}
      <div
      ...
      >
        ...
        <p className="text-md text-[#FF9A00] font-[poppins]">Master stock trading with step-by-step lessons, live simulations & AI-powered coaching</p>
      </div>

      {/* Bottom Section (80%) */}
      <div className="h-[80%] p-2 grid grid-cols-3 gap-4 justify-center">
        {modules.map((module, index) => (
          ...
          link={`/e-learning/modules/${module.id}`} // Dynamic Link
        />
        ))}
      </div>
    </div>
