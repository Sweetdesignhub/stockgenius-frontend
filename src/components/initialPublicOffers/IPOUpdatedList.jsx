...
function IPOUpdatedList({ipoData,setIpoData, loading, error, columns, fetchData}) {
  ...
  if (error) {
    return <div className="text-center text-[#FFFFFF]">NO Ipos to display, please add IPO</div>;
  }

  return (
    <div>
      <div className="pb-3 border-collapse border-b border-[#FFFFFF1A]">
              ...
              <div className="sm:w-1/3 w-full table-main rounded-lg p-3">
                ...
                <ol className="list-decimal pl-4">
                  {editableIpo.keyObjectives.map((objective, index) => (
                    <li key={index} className="text-[9px] text-[#6FD4FF] mb-1">
                      <input
                        type="text"
                        ...
                        <div className="flex items-center">
                          ...
                          <button className=" text-red-500 mr-2">
                            {editableIpoId === ipo._id && isEditing ? (
                              ...
                              <FaRegTrashAlt
                                onClick={() => handleDelete(ipoData[index]._id)}
                              />
                            )}
                          </button>
                        </div>
