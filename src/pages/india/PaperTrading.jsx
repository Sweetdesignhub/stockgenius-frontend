          ...
          <div className="flex items-center justify-between border-b-2 py-2 border-[#FFFFFF1A]">
            ...
            <div className="flex gap-3">
              ...
              <div className="relative group">
                ...
                <span className="absolute bottom-10 left-[-5px] right-0 text-center text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
                  Auto Trade
                </span>
              </div>
            </div>
