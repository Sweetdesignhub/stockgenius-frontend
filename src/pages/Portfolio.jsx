...
function Portfolio() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      console.log("No access token found. Display message to connect broker.");
    } else {
      setAccessToken(token); // Set access token state if present
    }
  }, []);
          ...
          <div className="py-5 px-5 flex flex-col rounded-2xl">
            ...
            {accessToken ? (
              ...
              <p className="text-center p-3">
                Select your broker to view your portfolio.
              </p>
            )}
          </div>
        </div>
