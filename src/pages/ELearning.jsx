...
function ELearning() {
  ...
  const isLearningDashboard = location.pathname === "/e-learning/learning" || location.pathname.startsWith("/e-learning/learning/");
  const getHeaderTitle = (path) => {
    if (path === "/e-learning") return "Welcome to Stock Genius Learning!";
    if (path.startsWith("/e-learning/learning")) return "Learning Dashboard";
