...
function ELearning() {
  ...
  <div className="-z-10 w-full">
    <div className="min-h-screen px-2 sm:px-4 md:px-6 lg:px-32 relative">
      ...
      <div className="bg-white min-h-[calc(100vh-1rem)] md:max-h-[120vh] news-table rounded-lg sm:rounded-xl md:rounded-2xl p-2 sm:p-3 md:p-4 flex flex-col gap-1 sm:gap-2 md:gap-3">
